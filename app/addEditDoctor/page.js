    ...
    const fetchData = async () => {
      try {
        ...
        const newRowData = result.data.map(doctor => ({
          ...
          email: doctor.Demail,
          password: doctor.Dpassword, // This will be hidden
          phone: doctor.Dphone,
  ...
  const handleAddRow = async () => {
    try {
      ...
      const newRowData = {
        ...
        password: otherData.Dpassword, // Hidden from table
    ...
    <div>
      <nav className={styles.sideNav}>
        <ul>
          ...
          <li><a href='/addEditPatient'>Patients</a></li>
          <li><a className={styles.active}>Doctors</a></li>
          <li><a href='/addEditNurse'>Nurses</a></li>
          <li><a href='/addEditDevice'>Devices</a></li>
          <li><a href='/adminBillings'>Patients' Payments</a></li>
        </ul>
      </nav>
      <div>
            ...
            {rows.map((row, rowIndex) => (
              <tr key={rowIndex}>
                {Object.keys(newRow).map((key) => {
                  // Skip password column in table rendering
